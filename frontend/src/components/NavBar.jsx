...
const NavBar = (props) => {
  const { Cart, setCart, setProducts, showSearch, setShowSearch, faves, setFaves} = props;
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
              ...
              <Link to='/'><h1 className="md:w-2/12 cursor-pointer text-gray-800 dark:text-white font-extrabold text-3xl" aria-label="">
                SmartMart
              </h1></Link>
              <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
              <li>
                  <Link to='/home'><a onClick={categoryAll} href="javascript:void(0)" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                    Home
                  </a></Link>
                </li>
                <li>
                  <a onClick={categoryMen} href="javascript:void(0)" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                    Men
                  </a>
                </li>
                <li>
                  <a onClick={categoryWomen} href="javascript:void(0)" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                    Women
                  </a>
                </li>
                <li>
              ...
              <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                <div className="lg:flex items-center">
                    <svg onClick={() => {setShowSearch(!showSearch)}}className="cursor-pointer fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                  <button onClick={() => setProducts(faves)} aria-label="view favourites" className="text-gray-800 dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                  ...
                  <button onClick={() => {setShowCart(!showCart)}} aria-label="go to cart" className="flex text-gray-800 dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                    <svg className="fill-stroke mr-1" width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {showCart && <CartModal Cart={Cart} setCart={setCart} showCart={showCart} setShowCart={setShowCart}/>}
    </div>
  );
};
