...
const NavBar = (props) => {
  const { setProducts, showSearch, setShowSearch} = props;
            ...
            <div className="container mx-auto flex items-center justify-between">
              ...
              <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                ...
                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                  ...
                  <Link to='/order'><button aria-label="go to cart" className="flex text-gray-800 dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
